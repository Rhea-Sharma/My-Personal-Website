...
typewriter.typeString('hey there!')
    ...
    .deleteAll()
    .pauseFor(300)
    .typeString("my name is rhea. (pronounced ree-uh)")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(300)
    .typeString("i'm a student at wilfrid laurier (go hawks!).")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(300)
    ...
    .deleteAll()
    .pauseFor(300)
    .typeString("big fan of iced matcha lattes.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(300)
    .typeString("i also run a lifestyle account.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(300)
